...
function Server(srv, opts){
  ...
  this.path(opts.path || '/socket.io'); // 服务路径
  this.serveClient(false !== opts.serveClient); // 是否为客户端提供客户端脚本服务
  this.parser = opts.parser || parser; // 解析器
  this.encoder = new this.parser.Encoder(); // 编码器
  this.adapter(opts.adapter || Adapter); // 适配器
  this.origins(opts.origins || '*:*'); // 设置cors跨域
